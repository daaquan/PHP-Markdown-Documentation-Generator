...
class ReflectorTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \DocsMd\Reflector
     */
    private $reflector;

    /**
     * @var \DocsMd\ClassEntity
     */
    private $class;
    ...
    protected function setUp()
    {
        ...
        $this->reflector = new \DocsMd\Reflector('Acme\\ExampleClass');
    ...
    public function testClass()
    {
        ...
        $refl = new \DocsMd\Reflector('Acme\\ExampleClassDepr');
        ...
        $refl = new \DocsMd\Reflector('Acme\\ExampleInterface');
        $class = $refl->getClassEntity();
    ...
    {
        $reflector = new \DocsMd\Reflector('Acme\\ClassWithStaticFunc');
    ...
    public function testParams()
    {
        ...
        $typeA = \DocsMd\Reflector::getParamType($paramA);
        $typeB = \DocsMd\Reflector::getParamType($paramB);
        $typeC = \DocsMd\Reflector::getParamType($paramC);
    ...
    {
        $reflector = new \DocsMd\Reflector('Acme\\ClassImplementingInterface');
        $functions = $reflector->getClassEntity()->getFunctions();
    ...
    {
        $reflector = new \DocsMd\Reflector('Acme\\InterfaceReferringToImportedClass');
        $functions = $reflector->getClassEntity()->getFunctions();
        $this->assertEquals('\\DocsMd\\Console\\CLI', $functions[1]->getReturnType());
        $this->assertEquals('\\DocsMd\\Console\\CLI[]', $functions[0]->getReturnType());
    }
}
